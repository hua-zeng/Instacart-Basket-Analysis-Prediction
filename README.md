...
Figure 2 indicates that the median number of products in an order is around 10. The distribution of number products in each order is right skewed. 
...
References: https://www.kaggle.com/c/instacart-market-basket-analysis
